...
export default function Footer() {
  ...
  return (
    <footer 
      className="w-full border-t border-gray-200 relative min-h-[400px] bg-cover bg-center bg-no-repeat"
      style={{
  ...
  <div className="flex flex-col space-y-3">
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-10 pr-20 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#BE968E] focus:border-transparent text-sm bg-white bg-opacity-20 text-white placeholder-gray-300"
        required
      />
      <button
        type="submit"
        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#BE968E] w-[120px] text-white p-2 rounded-lg hover:bg-[#a8827a] transition-colors flex items-center justify-center"
      >
        <span>send</span>
      </button>
    </div>
