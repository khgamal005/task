...
<form onSubmit={handleSubmit} className="mb-6">
  <div className="flex flex-col space-y-3">
    <div className="relative">
      ...
      <button
        type="submit"
        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#BE968E] w[] text-white p-2 rounded-lg hover:bg-[#a8827a] transition-colors flex items-center justify-center"
      >
        <span>send</span>
      </button>
    </div>
