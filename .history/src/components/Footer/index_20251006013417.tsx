          ...
          <div className="col-span-1">
              ...
              <div className="flex flex-col space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#BE968E] focus:border-transparent text-sm bg-white bg-opacity-20 text-white placeholder-gray-300"
                    required
                  />
                </div>
                <button
            ...
            <div className="space-y-3">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-[#BE968E] hover:text-white transition-colors text-white"
                >
