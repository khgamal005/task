...
export default function Navbar() {
  ...
  const links = [
    { id: crypto.randomUUID(), title: "Home", href: "#home" },
    { id: crypto.randomUUID(), title: "ourcategory", href: Routes.ourcategory },
    { id: crypto.randomUUID(), title: "AboutUs", href: Routes.CONTACT },
    { id: crypto.randomUUID(), title: "contactUs", href: Routes.CONTACT },
    { id: crypto.randomUUID(), title: "FAQs", href: Routes.FAQs },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* Conditional User Dropdown or Login Link */}
            {isLoggedIn ? (
          ...
          {/* Mobile Header - Burger menu on right */}
          <div className="md:hidden flex items-center justify-end w-full">
            {/* Conditional Login Link or Burger Menu */}
            {!isLoggedIn && (
              <Link 
                href="/signin"
        ...
        <div className="md:hidden bg-white border-t border-gray-200 py-4">
          ...
          <div className="px-4 border-t border-gray-200 mt-4 pt-4">
            <div className="flex items-center space-x-6">
              ...
              {/* Conditional User Dropdown or Login Link for Mobile */}
              {isLoggedIn ? (
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center gap-1 cursor-pointer p-1 hover:bg-gray-100 rounded">
                    <User className="w-5 h-5" />
