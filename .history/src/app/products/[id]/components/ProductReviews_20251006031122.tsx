  ...
  <div className="max-w-6xl mx-auto p-6 space-y-6">
    ...
    <div className="flex flex-col md:flex-row gap-8 items-center justify-between p-6">
      ...
      <div className="flex flex-col gap-4 items-center justify-center">
        <h4 className="font-semibold text-[20px]">Total Reviews</h4>
        <h4 className=" font-bold text-[20px]">{`${totalReviews}`}</h4>
import { MessageCircle } from "lucide-react";

<button
  className="flex items-center justify-center rounded-[12px] bg-[#BE968E] text-white font-semibold hover:bg-[#a8827a] transition-colors"
  style={{ width: "186px", height: "56px", gap: "8px", padding: "16px 32px" }}
>
