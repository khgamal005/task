...
export default function ProductTypeAccordion() {
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="type">
        <AccordionTrigger>
          <span className="text-[#BE968E] font-semibold">Type</span>
        </AccordionTrigger>
        <AccordionContent>
          <Select>
            <SelectTrigger
              className="w-[299px] h-[45px] border border-[#00000026] rounded-[10px] bg-white"
            >
