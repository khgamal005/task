      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center">
            <button className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-l px-4 py-2">
              -
            </button>
            <span className="bg-gray-200 text-gray-800 font-medium px-4 py-[11px]">
              {1}
            </span>
            <button className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-r px-4 py-2">
              +
            </button>
            <span>$300.00</span>
          </div>
