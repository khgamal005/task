...
<div className="space-y-2">
  {/* Title */}
  <h3 className="text-black font-medium text-[20px]">Quantity</h3><span>($300.00 for Piece)</span>
   {/* Quantity Selector */}
          ...
          <button
            className={` mt-6 rounded-[4px] h-11 flex items-center justify-center`}
          >
            <span className="text-white flex items-center">
              Add to cart < className="ml-1" />
            </span>
          </button>
