...
<div className="relative inline-block">
 ...
 <div className="flex flex-col md:flex-row gap-8 items-start md:items-center p-6">
      {/* First div: Rating */}
      <div className="relative flex items-end" style={{ width: "182px", height: "180px" }}>
        <h5
      ...
      <div className="flex-1 flex flex-col justify-center gap-2 w-full max-w-md">
        <div className="flex items-center gap-2">
      <Star className="w-6 h-6" fill="#BE968E" />
          <span className="font-poppins font-medium text-[16px]">{ratingPercentage}%</span>
        </div>
        <Progress value={ratingPercentage} className="w-full h-3 rounded-full" />
<span
  className="flex items-center justify-center font-poppins font-medium text-[20px] leading-[20px]"
  style={{
    width: "40px",
    height: "30px",
    backgroundColor: "#545454", // var(--Black-black-300)
    lineHeight: "100%",
    letterSpacing: "0",
  }}
>
