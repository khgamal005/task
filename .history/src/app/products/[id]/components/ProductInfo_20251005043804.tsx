...
<div className="flex flex-col md:flex-row gap-4 md:gap-6">
  ...
  <div className="flex-1">
    <div className="mb-2">
      <h3 className="text-lg font-semibold">
        Quantity <span className="text-gray-500 text-sm">($300.00 per Piece)</span>
      </h3>
    </div>
  ...
  <div className="flex-1">
    <button
      className={`${styles.button} mt-6 md:mt-0 rounded-[4px] h-11 w-full flex items-center justify-center`}
    >
